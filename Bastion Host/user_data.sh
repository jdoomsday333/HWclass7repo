...
<body>
    <div class="container">
        <h1>I Love Thailand</h1>
        <h2>I never want to leave</h2>
        
        <img src="https://myhotposters.com/cdn/shop/products/mGR0314_1024x1024.jpeg?v=1748543320" alt="Love" class="thailand">
